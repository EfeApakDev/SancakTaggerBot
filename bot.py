...
async def start(event):
  await event.reply("**sancak tagger bot **, ɢʀᴜᴘ ᴠᴇʏᴀ ᴋᴀɴᴀʟᴅᴀᴋɪ ɴᴇʀᴇᴅᴇʏꜱᴇ ᴛᴜᴍ ᴜʏᴇʟᴇʀᴅᴇɴ ʙᴀʜꜱᴇᴅᴇʙɪʟɪʀɪᴍ ʙᴜ ᴛᴜʀ ʙᴏᴛʟᴀʀ ɪᴄɪɴ ᴋᴏᴅ ꜱᴀʜɪʙɪ ɪʟᴇ ɪʟᴇᴛɪꜱɪᴍᴇ ɢᴇᴄɪɴ @sancakbegi ★\nᴅᴀʜᴀ ꜰᴀᴢʟᴀ ʙɪʟɢɪ ɪᴄɪɴ **/help**'i ᴛɪᴋʟᴀʏɪɴ.",
                    buttons=(
                      ...
                      Button.url('📣 ꜱᴜᴘᴘᴏʀᴛ', 'https://t.me/sancakbegi'),
                      Button.url('💻 ᴄʜᴀɴɴᴇʟ', 'https://t.me/CyberTurkish'),
                      Button.url('🚀 ꜱᴀʜɪʙɪᴍ', 'https://t.me/sancakbegi')]
                    ),
                    link_preview=False
                   )
...
print(">> ʙᴏᴛ ᴄᴀʟɪsıʏᴏʀ ᴍᴇʀᴀᴋ ᴇᴛᴍᴇ 🚀 @sancakbegi ʙɪʟɢɪ ᴀʟᴀʙɪʟɪʀꜱɪɴ <<")
