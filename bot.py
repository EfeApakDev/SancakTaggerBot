...
async def start(event):
  await event.reply("**ᴛᴀɢɢᴇʀʙᴏᴛꜱ**, ɢʀᴜᴘ ᴠᴇʏᴀ ᴋᴀɴᴀʟᴅᴀᴋɪ ɴᴇʀᴇᴅᴇʏꜱᴇ ᴛᴜᴍ ᴜʏᴇʟᴇʀᴅᴇɴ ʙᴀʜꜱᴇᴅᴇʙɪʟɪʀɪᴍ ʙᴜ ᴛᴜʀ ʙᴏᴛʟᴀʀ ɪᴄɪɴ ᴋᴏᴅ ꜱᴀʜɪʙɪ ɪʟᴇ ɪʟᴇᴛɪꜱɪᴍᴇ ɢᴇᴄɪɴ @Yorgun_Birisi ★\nᴅᴀʜᴀ ꜰᴀᴢʟᴀ ʙɪʟɢɪ ɪᴄɪɴ **/help**'i ᴛɪᴋʟᴀʏɪɴ.",
                    buttons=(
                      [Button.url('🌟 ʙᴇɴɪ ʙɪʀ ɢʀᴜʙᴀ ᴇᴋʟᴇ', 'https://t.me/Majeste_TaggerBot?startgroup=a'),
                      Button.url('📣 ꜱᴜᴘᴘᴏʀᴛ', 'https://t.me/Majesteler'),
                      Button.url('💻 ᴄʜᴀɴɴᴇʟ', 'https://t.me/MajesteBotlar'),
                      Button.url('🚀 ꜱᴀʜɪʙɪᴍ', 'https://t.me/Yorgun_Birisi')]
                    ),
                    link_preview=False
                   )
...
print(">> ʙᴏᴛ ᴄᴀʟɪʏᴏʀ ᴍᴇʀᴀᴋ ᴇᴛᴍᴇ 🚀 @Yorgun_Birisi ʙɪʟɢɪ ᴀʟᴀʙɪʟɪʀꜱɪɴ <<")
