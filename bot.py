...
api_id = int(os.environ.get("29365506"))
api_hash = os.environ.get("0bacb8797f8ddc47529e41682b40d797")
bot_token = os.environ.get("7447996200:AAHAVDRTIFv5omy4qjrxMSJgZyDxFgzneAg")
...
async def start(event):
  await event.reply("**sancak tagger bot **, ɢʀᴜᴘ ᴠᴇʏᴀ ᴋᴀɴᴀʟᴅᴀᴋɪ ɴᴇʀᴇᴅᴇʏꜱᴇ ᴛᴜᴍ ᴜʏᴇʟᴇʀᴅᴇɴ ʙᴀʜꜱᴇᴅᴇʙɪʟɪʀɪᴍ ʙᴜ ᴛᴜʀ ʙᴏᴛʟᴀʀ ɪᴄɪɴ ᴋᴏᴅ ꜱᴀʜɪʙɪ ɪʟᴇ ɪʟᴇᴛɪꜱɪᴍᴇ ɢᴇᴄɪɴ @sancakbegi ★\nᴅᴀʜᴀ ꜰᴀᴢʟᴀ ʙɪʟɢɪ ɪᴄɪɴ **/help**'i ᴛɪᴋʟᴀʏɪɴ.",
                    buttons=(
                      [Button.url('🌟 ɢʀᴜʙᴀ ᴇᴋʟᴇ', 'https://t.me/sancaktaggerbot?startgroup=a'),
                      Button.url('📣 ꜱᴜᴘᴘᴏʀᴛ', 'https://t.me/efebeyxdd'),
                      Button.url('💻 ᴄʜᴀɴɴᴇʟ', 'https://t.me/CyberTurkeyy'),
                      Button.url('🚀 ꜱᴀʜɪʙɪᴍ', 'https://t.me/efebeyxdd')]
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**sancakᴛᴀɢɢᴇʀ ʙᴏᴛ'ᴜɴ ʏᴀʀᴅɪᴍ ᴍᴇɴᴜꜱᴜ**\n\nKomut: /all \n  ʙᴜ ᴋᴏᴍᴜᴛᴜ, ʙᴀꜱᴋᴀʟᴀʀɪɴᴀ ʙᴀʜꜱᴇᴛᴍᴇᴋ ɪꜱᴛᴇᴅɪɢɪɴɪᴢ ᴍᴇᴛɪɴʟᴇ ʙɪʀʟɪᴋᴛᴇ ᴋᴜʟʟᴀɴᴀʙɪʟɪʀꜱɪɴɪᴢ. \n`ᴏʀɴᴇᴋ: /all Günaydın!`  \nʙᴜ ᴋᴏᴍᴜᴛᴜ ʏᴀɴɪᴛ ᴏʟᴀʀᴀᴋ ᴋᴜʟʟᴀɴᴀʙɪʟɪʀꜱɪɴɪᴢ. ʜᴇʀʜᴀɴɢɪ ʙɪʀ ᴍᴇꜱᴀᴊ ʙᴏᴛ, ʏᴀɴɪᴛʟᴀɴᴀɴ ɪʟᴇᴛɪʏᴇ ᴋᴜʟʟᴀɴɪᴄɪʟᴀʀɪ ᴇᴛɪᴋᴇᴛʟᴇʏᴇᴄᴇᴋ"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('🌟 ʙᴇɴɪ ʙɪʀ ɢʀᴜʙᴀ ᴇᴋʟᴇ', 'https://t.me/sancaktaggerBot?startgroup=a'),
                       Button.url('📣 ꜱᴜᴘᴘᴏʀᴛ', 'https://t.me/efebeyxdd'),
                       Button.url('💻 ᴄʜᴀɴɴᴇʟ', 'https://t.me/CyberTurkeyy'),
                      Button.url('🚀 ꜱᴀʜɪʙɪᴍ', 'https://t.me/efebeyxdd')]
                    ),
...
elif str(new_user.id) == str(5468354087):
            await msg.reply('İşte bu gelen benim sahibim.')

print(">> ʙᴏᴛ ᴄᴀʟɪsıʏᴏʀ ᴍᴇʀᴀᴋ ᴇᴛᴍᴇ 🚀 @efebeyxdd ʙɪʟɢɪ ᴀʟᴀʙɪʟɪʀꜱɪɴ <<")
